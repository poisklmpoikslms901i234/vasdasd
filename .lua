--linsence: https://raw.githubusercontent.com/poisklmpoikslms901i234/venusUI/main/.lua
...
local themes = {
    Default = {
        ["Accent"] = Color3.fromRGB(10,171,211),
        ["Window Background"] = Color3.fromRGB(0,0,0),
        ["Window Border"] = Color3.fromRGB(0,0,0),
        ["Tab Background"] = Color3.fromRGB(0,0,0),
        ["Tab Border"] = Color3.fromRGB(0,0,0),
        ["Tab Toggle Background"] = Color3.fromRGB(0,0,0),
        ["Section Background"] = Color3.fromRGB(0,0,0),
        ["Section Border"] = Color3.fromRGB(39, 37, 37),
        ["Text"] = Color3.fromRGB(255, 255, 255),
        ["Disabled Text"] = Color3.fromRGB(118, 118, 118),
        ["Object Background"] = Color3.fromRGB(2, 0, 9),
        ["Object Border"] = Color3.fromRGB(0,0,0),
        ["Dropdown Option Background"] = Color3.fromRGB(0,0,0)
    },

    Midnight = {
        ["Accent"] = Color3.fromRGB(0,255,229),
